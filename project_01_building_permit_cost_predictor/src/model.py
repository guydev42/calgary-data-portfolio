"""ML model training and evaluation for Building Permit Cost Prediction."""
...
CATEGORICAL_FEATURES = [
    "permittype", "permitclass", "permitclassgroup",
    "workclass", "workclassgroup",
]

NUMERICAL_FEATURES = [
    "totalsqft", "housingunits", "apply_year", "apply_month",
    "apply_dayofweek", "latitude", "longitude",
...
def train_models(X, y, random_state=42):
    ...
    for name, model in models.items():
        ...
        # Clip predictions to training data range to avoid exponential blowup
